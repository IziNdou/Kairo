...
export default function SignIn({ navigateTo, onSignInComplete }: SignInProps) {
        ...
        <div className="bg-black rounded-2xl shadow-lg p-8 space-y-6 border border-white/10">
          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/90">Sign in to continue to Kairo</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="text-sm text-[#A67395] hover:underline"
                >
                  Forgot password?
                </button>
              </div>
